...
<html>
	...
	<body>
		...
		<div class="mui-content">
			...
			<div class="mui-input-row">
				<label><span class="mui-icon mui-icon-person"></span></label>
				<input type="text" name="nickname" class="mui-input-clear" placeholder="请 输 昵 称"  id="user1">
			</div>
			<div class="mui-input-row">
			...
			<div class="mui-input-row">
				<label><span class="mui-icon mui-icon-locked"></span></label>
				<input type="password" name="pwd1" class="mui-input-clear" placeholder="重复密码" id="pwd1">
			</div>
			<div class="mui-input-row">
				<label><span class="mui-icon mui-icon-locked"></span></label>
			...
			<button class="mui-btn mui-btn-primary mui-btn-block" id="login" type="submit">立即注册</button>
